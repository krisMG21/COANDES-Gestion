...
La empresa COANDES necesita un sistema informático para gestionar outsourcing para mantenimiento de software.

Se necesita llevar control de las empresas clientes y los proyectos asociados y las aplicaciones que lo conformen.
...
Estos ficheros se cargan de forma manual desde el correo, cuya carga genera un fichero `log` con el resultado del proceso.
